...
<template>
  <div>
    ...
    <template v-else>
          ...
          <div class="flex-1 min-w-0 basis-full sm:basis-0">
            ...
            <p class="text-sm text-muted">
              ...
              <UserPopover
                ...
                :avatar="community.creator_avatar"
              />
            </p>
          </div>
      ...
      <!-- Invite panel -->
      <div
        v-if="showInvitePanel && canInvite"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
          ...
          <div
            v-if="!community.activity?.length"
          ...
          >
            ...
            >
              ...
              >
                <UIcon
                  :name="item.type === 'session' ? 'i-lucide-gamepad-2' : 'i-lucide-calendar'"
                  class="size-4"
                />
              </div>
