...
<template>
  <UPopover
    ...
    :open-delay="300"
    :close-delay="200"
    @update:open="(open: boolean) => open && fetchSummary()"
  >
    <slot>
    ...
    <template #content>
      <div class="w-72 p-4">
        ...
        <template v-else-if="summary">
          ...
          <div
            v-if="summary.battleTags?.length > 0"
            class="mb-3"
          >
            <div class="flex flex-wrap gap-1.5">
              ...
              >
                <UIcon
                  :name="platformIcons[bt.platform] ?? 'i-lucide-gamepad-2'"
                  class="size-3"
                />
                {{ bt.tag }}
              </span>
          ...
          <!-- Shared communities -->
          <div
            v-if="summary.sharedCommunities?.length > 0 && !summary.isSelf"
            class="mb-3"
          >
