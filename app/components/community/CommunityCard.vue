    ...
    <div class="flex h-full">
      ...
      <div class="flex-1 min-w-0 p-4">
        <div class="flex items-center gap-2 mb-1">
          ...
          <UBadge v-if="invited" color="warning" variant="subtle" size="sm">
            Invitation
          </UBadge>
          <UBadge v-else-if="community.is_member" color="success" variant="subtle" size="sm">
            Membre
          </UBadge>
          <UBadge v-if="!community.is_public" color="neutral" variant="subtle" size="sm">
            Privee
          </UBadge>
        </div>

        <p v-if="community.description" class="text-sm text-muted mb-1 line-clamp-2">
